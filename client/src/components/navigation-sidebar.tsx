...
const createTableOfContents = () => {
  const tableOfContents: Array<{ id: string; title: string; level: number; searchText: string }> = [
    ...
    { id: "media-analysis", title: "6.1 Media Analysis", level: 1, searchText: "Media consumption" },
    { id: "professional-applications", title: "6.2 Professional Applications", level: 1, searchText: "Professional Success" },
